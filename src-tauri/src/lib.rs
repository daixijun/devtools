...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            tools::csr_generator::generate_csr,
            tools::csr_parser::parse_csr,
            ...
            tools::rsa_key_generator::generate_rsa_keypair,
            ...
            tools::image_compressor::compress_image,
            tools::image_compressor::read_image_data_url,
